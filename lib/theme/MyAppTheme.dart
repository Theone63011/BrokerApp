  ...
  static ThemeData data() {
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        bodyText1: TextStyle(color: Colors.white, fontSize: 14.0, fontWeight: FontWeight.bold, fontFamily: 'Roboto', shadows: shadows),
        bodyText2: TextStyle(color: Colors.white, fontSize: 14.0, fontWeight: FontWeight.bold, fontFamily: "Rock Salt",
            shadows: shadows),
      ),
